...
!!! info "备注"
    ...
    - 读卡器刚刚启动时的LED颜色表示了目前状态。蓝色表示处于高波特率模式，绿色表示处于低波特率模式，红色表示找不到PN532模块，启动失败。启动失败的状态下将无法连接到PC。当接收到游戏发来的灯光指令时，读卡器的灯光将会交由游戏控制。因此进入游戏后，灯光将不再能表征读卡器的状态。
...
!!! info ""
    支持所有使用spice的KONAMI游戏:[读卡器spice模式教程](\AimeManual\kobatospice)

!!! info ""
    支持所有使用太鼓达人和高达等的万代南梦宫游戏:[读卡器namco模式教程](\AimeManual\kobatonamco)
...
!!! info ""
    ...
    <div style="text-align:center;margin:8px;">
        <img alt="image.png" src="../../assets/images/aimemanual/kobato/1.png">
        <img alt="image.png" src="../../assets/images/aimemanual/kobato/2.png">
        <img alt="image.png" src="../../assets/images/aimemanual/kobato/3.png">
    </div>
...
!!! note "注意"
    ...
    - F1版的端口在设备管理器中应该显示为Maple Serial，F0版的端口应该显示为USB串行设备（未安装驱动时）或STM Serial（安装驱
